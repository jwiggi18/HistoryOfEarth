...
g.addEventListener("change", function() {
    ...
    document.getElementById("section-more_info").innerHTML = "<a href=" taxoninfo[$("#genus").prop("selectedIndex")].Link) + ">Learn more about taxoninfo[$("#genus").prop("selectedIndex")].Genus</a>";
