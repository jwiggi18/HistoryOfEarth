...
knitr::asis_output(htmltools::htmlPreserve('<p id="demo">demohere</p>'))
...
document.getElementById("demo").innerHTML = JSON.stringify(obj[2].Genus);
</script>
')))
```
...
g.addEventListener("change", function() {
    ...
    alert(JSON.stringify(obj[document.getElementById("genus").selectedIndex].Genus));
