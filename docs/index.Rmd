...
shiny::fluidRow(
  column(4, align="center",
    htmltools::img(id="organismphoto", src="https://upload.wikimedia.org/wikipedia/commons/c/c1/La_Brea_Tar_Pits.jpg", alt="picture of the selected organism")
  ),
  column(8, align="center",
...
g.addEventListener("change", function() {
    ...
    alert(selected.val() + " " + selected.text() + str_chosenperiod);
...
<img id="organismphoto" src="https://upload.wikimedia.org/wikipedia/commons/c/c1/La_Brea_Tar_Pits.jpg" alt="picture of the selected organism"/>

<img id="map" src="img/map_all_all.gif" alt="map of plates"/>

<img id="tree" src="img/tree_all_all.jpg" alt="phylogeny of organisms"/>
